...
<input name="id" value="<?php echo set_value('id',@$r['id']);?>" type="hidden" />
	...
	<tr class="altrow" >
		<td>
			...
			<label><span class="req">*</span>Fecha:</label>
				<input id="fecha_alt" type="hidden" name="fecha" value="<?php echo set_value('fecha',$date); ?>" readonly="readonly"/>
				<input id="fecha"  class="fecha"  value="<?php ver_fecha(set_value('fecha',$date)); ?>" />
...
<tbody>
	<tr>
		<td>
			...
			<input id="razon_social"  name="razon_social"  value="<?php echo set_value('razon_social'); ?>"/>
...
<tbody>	
	...
	<tr>
		...
		<td>
			...
			<input id="iva_porcentaje"  name="iva_porcentaje"   readonly="readonly"  value="<?php echo set_value('iva_porcentaje',@$r['iva_porcentaje']); ?>" readonly="readonly"/>
	...
	<tr class="altrow">
		<td>
			...
			<select name="vendedor" id="vendedor" >
				...
				<option value="<?php echo $v['id']; ?>" <?php echo set_select('vendedor', @$v['id']); ?> ><?php echo $v['nombre'].' '.$v['apellido_paterno'].' '.$v['apellido_materno']; ?></option>
				<?php endforeach;?>
			</select>
		...
		<!--  <td>
			...
			<input id="paterno_vendedor"  name="paterno_vendedor"  value="<?php echo set_value('paterno_vendedor',@$r['cotizacion']->paterno_vendedor); ?>"/>
			<?php echo  form_error('paterno_vendedor');?>	
		</td>
		<td>
			<label><span class="req">*</span>Apellido Materno:</label>
			<input id="materno_vendedor"  name="materno_vendedor"  value="<?php echo set_value('materno_vendedor',@$r['cotizacion']->materno_vendedor); ?>"/>
			<?php echo  form_error('materno_vendedor');?>	
		</td>-->
	</tr>
	</tbody>
</table>			
...
<table class="table_form">
	...
	<tr class="altrow">
		<td align="center">
			<textarea id="observaciones" name="observaciones" class="w90p" rows="6"><?php echo set_value('observaciones'); ?></textarea>
...
$(function(){
	...
	$('.buscar').click(function(){
		$(this).parent('div').next('div.lista').show();
