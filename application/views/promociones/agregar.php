		...
		<form action="<?php echo site_url(uri_string()); ?>" id="form" method="post" enctype="multipart/form-data">
			<div class="panel-group">
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
									...
									<input  id="vigencia_desde_alt" name="vigencia_desde" value="<?php echo set_value('vigencia_desde',@$_POST['vigencia_desde']); ?>" type="hidden" />
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
									...
									<input  id="vigencia_hasta_alt" name="vigencia_hasta" value="<?php echo set_value('vigencia_hasta',@$_POST['vigencia_hasta']); ?>" type="hidden" />
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
									...
									<input type="text" class="form-control" id="monto_minimo" name="monto_minimo" value="<?php echo  @$_POST['monto_minimo']; ?>" />
				...
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><span class="req">*</span>Participantes en la promoci&oacute;n</a>
						</h4>
					</div>
										...
										<fieldset class="scheduler-border">
											...
											<div id="categorias_add">
												...
												<?php if(@$_POST['categorias']): ?>
													...
													?>
													<?php foreach($_POST['categorias'] as $clave=>$valor): ?>
														<div class="row">
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
																<select style="width: 100%" class="selectsCategoria" id="categorias[]" name="categorias[]" >
																	<option value=""><?php echo $this->config->item('empty_select'); ?></option>
																	<?php foreach($categorias as $k=>$v):?>
																		<option value="<?php echo $k;?>" <?php echo ($k == $valor)?'selected="selected"':''; ?>><?php echo $v;?></option>
																	<?php endforeach;?>
																</select>
															</div>
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
																<input type="text" class="form-control" id="cantidadCategorias[]" name="cantidadCategorias[]" value="<?php echo @$_POST['cantidadCategorias'][$clave];?>" />
															</div>
															<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
																<input type="button" value="-" class="eliminarCategoria" style="width: 25px; height: 25px">
															</div>
									...
									<div class="panel-body">
										<fieldset class="scheduler-border">
											...
											<div id="productos_add">
												...
												<?php if(@$_POST['productos']): ?>
													<?php
													unset($_POST['productos'][0]);
													unset($_POST['cantidadProductos'][0]);
													?>
													<?php foreach($_POST['productos'] as $clave=>$valor): ?>
														<div class="row">
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
															...
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
																<input type="text" class="form-control" id="cantidadProductos[]" name="cantidadProductos[]" value="<?php echo @$_POST['cantidadProductos'][$clave];?>" />
															</div>
															<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
																<input type="button" value="-" class="eliminarProducto" style="width: 25px; height: 25px">
															</div>
									...
									<div class="panel-body">
										<fieldset class="scheduler-border">
											...
											<div id="accesorios_add">
												...
												<?php if(@$_POST['accesorios']): ?>
													<?php
													unset($_POST['accesorios'][0]);
													unset($_POST['cantidadAccesorios'][0]);
													?>
													<?php foreach($_POST['accesorios'] as $clave=>$valor): ?>
														<div class="row">
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
															...
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
																<input type="text" class="form-control" id="cantidadAccesorios[]" name="cantidadAccesorios[]" value="<?php echo @$_POST['cantidadAccesorios'][$clave];?>" />
															</div>
															<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
																<input type="button" value="-" class="eliminarAccesorio" style="width: 25px; height: 25px">
															</div>
									...
									<div class="panel-body">
										<fieldset class="scheduler-border">
											...
											<div id="consumibles_add">
												...
												<?php if(@$_POST['consumibles']): ?>
													<?php
													unset($_POST['consumibles'][0]);
													unset($_POST['cantidadConsumibles'][0]);
													?>
													<?php foreach($_POST['consumibles'] as $clave=>$valor): ?>
														<div class="row">
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
															...
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-4">
																<input type="text" class="form-control" id="cantidadConsumibles[]" name="cantidadConsumibles[]" value="<?php echo @$_POST['cantidadConsumibles'][$clave];?>" />
															</div>
															<div class="col-lg-2 col-md-2 col-sm-2 col-xs-4">
																<input type="button" value="-" class="eliminarConsumible" style="width: 25px; height: 25px">
															</div>
								...
								<div class="col-lg-6">
									...
									<div class="panel-body">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 form-group">
											...
											<input type="text" class="form-control" id="monto_descuento" name="monto_descuento" value="<?php echo @$_POST['monto_descuento']; ?>" />
											...
											<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
												...
												<legend class="scheduler-border">Productos/Eventos:</legend>
													...
													<div id="regalos_productos_add">
														...
														<?php if(@$_POST['regaloProductos']): ?>
															<?php
															unset($_POST['regaloProductos'][0]);
															unset($_POST['cantidadRegalosProductos'][0]);
															?>
															<?php foreach($_POST['regaloProductos'] as $clave=>$valor): ?>
																<div class="row">
																	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
																	...
																	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
																		<input type="text" class="form-control" id="cantidadRegalosProductos[]" name="cantidadRegalosProductos[]" value="<?php echo @$_POST['cantidadRegalosProductos'][$clave];?>" />
																	</div>
																	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
																		<input type="text" class="form-control" id="porcentajeRegalosProductos[]" name="porcentajeRegalosProductos[]" value="<?php echo @$_POST['porcentajeRegalosProductos'][$clave];?>" />
																	</div>
																	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
																		<input type="button" value="-" class="eliminarRegalosProducto" style="width: 25px; height: 25px">
																	</div>
											...
											<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
												<fieldset class="scheduler-border">
													...
													<div id="regalos_accesorios_add">
														...
														<?php if(@$_POST['regaloAccesorios']): ?>
															<?php
															unset($_POST['regaloAccesorios'][0]);
															unset($_POST['cantidadRegalosAccesorios'][0]);
															?>
															<?php foreach($_POST['regaloAccesorios'] as $clave=>$valor): ?>
																<div class="row">
																	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
																	...
																	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
																		<input type="text" class="form-control" id="cantidadRegalosAccesorios[]" name="cantidadRegalosAccesorios[]" value="<?php echo @$_POST['cantidadRegalosAccesorios'][$clave];?>" />
																	</div>
																	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
																		<input type="text" class="form-control" id="porcentajeRegalosAccesorios[]" name="porcentajeRegalosAccesorios[]" value="<?php echo @$_POST['porcentajeRegalosAccesorios'][$clave];?>" />
																	</div>
																	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
																		<input type="button" value="-" class="eliminarRegaloAccesorio" style="width: 25px; height: 25px">
																	</div>
												...
												<fieldset class="scheduler-border">
													...
													<div id="regalos_consumibles_add">
														<div class="row" style="display:none;">
															...
															<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
																<input type="text" class="form-control" id="cantidadRegaloConsumibles[]" name="cantidadRegaloConsumibles[]" value="" />
															</div>
															<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
														...
														<?php if(@$_POST['regaloConsumibles']): ?>
															<?php
															unset($_POST['regaloConsumibles'][0]);
															unset($_POST['cantidadRegaloConsumibles'][0]);
															?>
															<?php foreach($_POST['regaloConsumibles'] as $clave=>$valor): ?>
																<div class="row">
																	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
																	...
																	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
																		<input type="text" class="form-control" id="cantidadRegaloConsumibles[]" name="cantidadRegaloConsumibles[]" value="<?php echo @$_POST['cantidadRegaloConsumibles'][$clave];?>" />
																	</div>
																	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
																		<input type="button" value="-" class="eliminarRegaloConsumible" style="width: 25px; height: 25px">
																	</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
											<fieldset class="scheduler-border">
												...
												<div id="regalos_alianzas_add">
													...
													<?php if(@$_POST['regaloAlianzas']): ?>
														<?php
														unset($_POST['regaloAlianzas'][0]);
														unset($_POST['cantidadRegaloAlianzas'][0]);
														?>
														<?php foreach($_POST['regaloAlianzas'] as $clave=>$valor): ?>
															<div class="row">
																<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
																	<select style="width: 100%" class="selectsRegaloAlianzas" id="regaloAlianzas[]" name="regaloAlianzas[]" >
																		<option value=""><?php echo $this->config->item('empty_select'); ?></option>
																		<?php foreach($alianzas as $k):?>
																			<option value="<?php echo $k->id;?>" <?php echo ($k->id == $valor)?'selected="selected"':''; ?>><?php echo $k->nombre;?></option>
																		<?php endforeach;?>
																	</select>
																</div>
																<div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
																	<input type="text" class="form-control" id="cantidadRegalosAlianzas[]" name="cantidadRegalosAlianzas[]" value="<?php echo @$_POST['cantidadRegalosAlianzas'][$clave];?>" />
																</div>
																<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
																	<input type="button" value="-" class="eliminarAlianza" style="width: 25px; height: 25px">
																</div>
