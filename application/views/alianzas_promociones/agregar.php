					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
								...
								<input id="nombre" name="nombre" class="form-control" type="text" value="<?php echo set_value('nombre',@$_POST['nombre']);?>" />
								<?php echo  form_error('nombre');?>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
								<label><span class="req">*</span>Prefijo:</label>
								<input type="text" class="form-control" id="prefijo" name="prefijo" value="<?php echo @$_POST['prefijo']; ?>" />
								<?php echo  form_error('prefijo');?>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
								<label><span class="req">*</span>N&uacute;mero de folios:</label>
								<input id="numero_folios" name="numero_folios" class="form-control" type="text" value="<?php echo set_value('numero_folios',@$_POST['numero_folios']);?>" />
								<?php echo  form_error('numero_folios');?>
							</div>
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
								<label>Descripci&oacute;n:</label>
								<textarea rows="4" cols="50" id="descripcion" name="descripcion" class="form-control"><?php echo set_value('descripcion',@$_POST['descripcion']);?></textarea>
