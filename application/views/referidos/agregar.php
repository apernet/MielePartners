				    ...
				    <div id="collapseOne" class="panel-collapse collapse in">
						<div class="panel-body">
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
									<label><span class="req">*</span>Distribuidor:</label>
									...
									<?php else:?>
										...
										<input class="form-control" type="text" value="<?php echo isset($distribuidores[$this->session->userdata('cuentas_id')])?$distribuidores[$this->session->userdata('cuentas_id')]:''; ?>" disabled="disabled"/>
									<?php endif;?>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
