				      ...
				      <div class="panel-body">
				        <div class="row">
				        	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
								...
								<input class="form-control" id="titulo" name="titulo" value="<?php echo set_value('titulo'); ?>" />
								<?php echo  form_error('titulo');?>
				        	</div>
				        	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
				        		<label ><span class="req">*</span>Fecha:</label>
								<input id="fecha_alt" name="fecha" value="<?php echo set_value('fecha'); ?>" type="hidden" />
								<input class="form-control fecha" id="fecha" value="<?php echo get_fecha(set_value('fecha')); ?>" />
				        	...
				        	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
				        		<div class="checkbox">
					        		...
					        		<label>Mostrar al inicio</label>
										<input type="checkbox" name="inicio" value="1" <?php echo set_checkbox('inicio','1',TRUE); ?> />
