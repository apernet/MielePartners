		      	...
		      	<div class="panel-body">
			        <div class="row">
			            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
			        		...
			        		<input class="form-control <?php echo form_error('nombre_contacto')?'rojo':'';?>" type="text" id="nombre_contacto"  name="nombre_contacto"  value="<?php echo set_value('nombre_contacto',@$r['nombre_contacto']); ?>"/>
						<?php echo form_error('nombre_contacto');?>
		        		</div>
			        	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
			        		<label><span class="req">*</span>Tel&eacute;fono particular:</label>
			        		<input class="form-control <?php echo form_error('telefono_particular')?'rojo':'';?>" type="text" id="telefono_particular"  name="telefono_particular"  value="<?php echo set_value('telefono_particular',@$r['telefono_particular']); ?>" />
							<?php echo form_error('telefono_particular');?>
			        	</div>
			        	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
			        		<label>Tel&eacute;fono celular:</label>
			        		<input class="form-control <?php echo form_error('telefono_celular')?'rojo':'';?>" type="text" id="telefono_celular"  name="telefono_celular"  value="<?php echo set_value('telefono_celular',@$r['telefono_celular']); ?>" />
				       ...
				       <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
			        		...
			        		<input class="form-control fecha <?php echo form_error('entrega_fecha_tentativa')?'rojo':'';?>" type="text" id="entrega_fecha_tentativa" value="<?php echo get_fecha(@$r['entrega_fecha_tentativa']); ?>" />
