...
<tbody>
	<tr>
		...
		<td>
			...
			<input id="folio" name="folio" value="<?php echo set_value('folio', @$r->folio); ?>" />
	...
	<tr>
		...
		<td>
			...
			<input id="contrasena" name="contrasena" value="<?php echo set_value('contrasena', @$r->contrasena); ?>" />
...
<div class="footer_form">		
	...
	<a href="<?php echo site_url('newsletters/index');?>" class="fl p5 ml5">Cancelar</a>
