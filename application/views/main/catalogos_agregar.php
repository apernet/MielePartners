<?php if(!is_ajax()){ $this->load->view('layout/header'); } ?>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
						...
						<input class="form-control" type="text"  id="nombre" name="nombre" value="<?php echo set_value('nombre'); ?>" />
						<?php echo  form_error('nombre');?>
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
						<label><span class="req">*</span>Descripci&oacute;n:</label>
						<input class="form-control" type="text" id="descripcion" name="descripcion" value="<?php echo set_value('descripcion'); ?>" />
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 barra-btn">
		...
		<a href="<?php echo site_url('main/catalogos');?>" class="  btn btn-default pull-right">Cancelar</a>
