			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
					...
					<select  class="form-control" id="catalogos_id" name="catalogos_id">
						...
						<option value="<?php echo $k; ?>" <?php echo set_select('catalogos_id', $k); ?>><?php echo $v; ?></option>
						<?php endforeach;?>
					</select>
				...
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 form-group">
					...
					<input class="form-control" id="valor" name="valor" value="<?php echo set_value('valor'); ?>" />
