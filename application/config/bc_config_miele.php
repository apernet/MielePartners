<?php
/* EMAIL */
$config['mail_compra_venta_directa']=array('montserrat.badiola@miele.com.mx', 'leslye.manilla@miele.com '); 	// COMPRAS NUEVAS VENTA DIRECTA PARA MIELE PARTNERS
...
$config['mail_venta_cliente_externo']=array('paola.mesura@miele.com.mx', 'leslye.manilla@miele.com'); // COMPRAS NUEVAS VENTA DIRECTA PARA MIELE SHOP
